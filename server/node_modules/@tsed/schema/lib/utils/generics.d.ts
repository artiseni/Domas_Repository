...
export declare type GenericValue = Type<any> | JsonSchema | any;
/**
 * @ignore
 */
export declare type GenericsMap = Map<string, GenericValue>;
/**
 * @ignore
 */
 ...
 * @param genericTypes
 */
export declare function getGenericsMap(genericLabels: string[], genericTypes: GenericValue[]): GenericsMap;
/**
 * @ignore
 * @param options
 */
