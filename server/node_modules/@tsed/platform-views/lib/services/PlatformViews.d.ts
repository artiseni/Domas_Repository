...
import { PlatformViewEngine, PlatformViewsEngineOptions, PlatformViewsExtensionsTypes } from "../domain/PlatformViewsSettings";
/**
 * @platform
 */
export declare class PlatformViews {
     ...
     * @deprecated
     */
    loadFromConsolidate(): Promise<void>;
    loadFromTsedEngines(): Promise<void>;
    getEngines(): {
        extension: string;
    ...
    render(viewPath: string, options?: any): Promise<string>;
