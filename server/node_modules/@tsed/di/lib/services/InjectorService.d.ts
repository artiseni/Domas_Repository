import { BaseContext, ProviderScope } from "../domain";
import { Container } from "../domain/Container";
import { LocalsContainer } from "../domain/LocalsContainer";
import { Provider } from "../domain/Provider";
import { DILogger, InjectablePropertyService, InjectablePropertyValue, InvokeOptions, IProvider, TokenProvider } from "../interfaces";
...
export declare class InjectorService extends Container {
    ...
    constructor();
    get resolvers(): import("../interfaces").DIResolver[];
    get scopes(): {
     ...
     */
    bindMethod(instance: any, { propertyKey }: InjectablePropertyService): void;
    /**
     ...
     * @param invokeOptions
     */
    bindProperty(instance: any, { propertyKey, useType, onGet, options }: InjectablePropertyService, locals: Map<TokenProvider, any>, invokeOptions: Partial<InvokeOptions>): void;
    /**
     *
     * @param instance
     * @param {string} propertyKey
     ...
     * @param {any} useType
     */
    bindConstant(instance: any, { propertyKey, expression, defaultValue }: InjectablePropertyValue): PropertyDescriptor;
    /**
     *
     * @param instance
     * @param propertyKey
     ...
     * @param options
     */
    bindInterceptor(instance: any, { propertyKey, useType, options }: InjectablePropertyService): void;
     ...
     * @protected
     */
    runInContext(ctx: BaseContext, cb: any): any;
}
