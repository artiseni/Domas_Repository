...
export declare class ContextLogger {
    ...
    constructor(logger: any, { id, dateStart, ignoreUrlPatterns, minimalRequestPicker, completeRequestPicker, level, maxStackSize, ignoreLog, additionalProps }: ContextLoggerOptions);
    info(obj: any): this;
