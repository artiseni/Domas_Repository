...
class Provider {
    ...
    clone() {
        ...
        core_1.getEnumerableKeys(this).forEach((key) => {
    ...
    toString() {
        return [
            "Token",
            this.name,
            this.useClass && core_1.nameOf(this.useClass),
