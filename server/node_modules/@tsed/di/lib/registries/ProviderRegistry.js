...
exports.registerController = exports.registerService = exports.registerValue = exports.registerFactory = exports.registerProvider = void 0;
 ...
 *
 */
GlobalProviders_1.GlobalProviders.createRegistry(domain_1.ProviderType.CONTROLLER, Provider_1.Provider, {
    injectable: false
});
/**
 ...
 */
exports.registerFactory = registerProvider;
/**
...
const registerValue = (provider, value) => {
    ...
    provider = Object.assign({
        ...
        useValue: value
    }, provider, { type: domain_1.ProviderType.VALUE });
    GlobalProviders_1.GlobalProviders.merge(provider.provide, provider);
};
 ...
 * @deprecated Since 2021-05-15. Use registerProvider instead.
 */
exports.registerService = GlobalProviders_1.GlobalProviders.createRegisterFn(domain_1.ProviderType.SERVICE);
/**
 ...
 * @param provider Provider configuration.
 */
exports.registerController = GlobalProviders_1.GlobalProviders.createRegisterFn(domain_1.ProviderType.CONTROLLER);
