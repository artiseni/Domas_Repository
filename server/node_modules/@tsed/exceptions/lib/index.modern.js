import { getStatusConstant, HTTP_STATUS_MESSAGES } from '@tsed/schema';
...
const HTTP_STATUSES = HTTP_STATUS_MESSAGES;
...
export { BadGateway, BadMapping, BadRequest, BandwidthLimitExceeded, Conflict, Exception, ExpectationFailed, Forbidden, GatewayTimeout, Gone, HTTPException, HTTP_STATUSES, ImATeapot, InternalServerError, LengthRequired, MethodNotAllowed, MisdirectedRequest, MovedPermanently, MovedTemporarily, MultipleChoices, NetworkAuthenticationRequired, NotAcceptable, NotExtended, NotFound, NotImplemented, NotModified, PaymentRequired, PermanentRedirect, PreconditionFailed, PreconditionRequired, ProxyAuthentificationRequired, ProxyError, RequestEntityTooLarge, RequestHeaderFieldsTooLarge, RequestRangeUnsatisfiable, RequestTimeout, RequestURITooLong, SeeOther, ServiceUnvailable, TemporaryRedirect, TooManyRedirects, TooManyRequests, Unauthorized, UnavailableForLegalReasons, UnprocessableEntity, UnsupportedMediaType, UpgradeRequired, UseProxy, VariantAlsoNegotiates };
