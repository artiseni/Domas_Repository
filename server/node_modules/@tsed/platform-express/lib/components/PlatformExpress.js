...
class PlatformExpress extends common_1.PlatformBuilder {
    ...
    useContext() {
        ...
        this.app.getApp().use(async (req, res, next) => {
            await common_1.createContext(this.injector, this.createRequest(req), this.createResponse(res));
            return next();
        });
        return this;
    }
    async loadRoutes() {
        ...
        this.app.use((req, res, next) => {
            var _a;
            !res.headersSent && ((_a = this.injector.get(common_1.PlatformExceptions)) === null || _a === void 0 ? void 0 : _a.resourceNotFound(req.$ctx));
        });
        // EXCEPTION FILTERS
        this.app.use((err, req, res, next) => {
            var _a;
            !res.headersSent && ((_a = this.injector.get(common_1.PlatformExceptions)) === null || _a === void 0 ? void 0 : _a.catch(err, req.$ctx));
        });
    }
